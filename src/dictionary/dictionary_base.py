...
import torch
from dictionary_update import dico_update, dico_update_batched, dico_update_batched_cv_check
from utils import proj_C

IMPLEMENTED_DICTIONARY_UPDATE = {"basic_update" : dico_update, "quick_update" : dico_update_batched,
                                 "quick_update_cv_check" : dico_update_batched_cv_check}


class DictionaryBase:

    def __init__(self, m, k, dico_update = "quick_update"):
    ...
    def update_dictionary(self, **kwargs):
        ...
        return update_implementation(self.D, self.A,self.B,**kwargs)
